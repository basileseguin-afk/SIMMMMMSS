...
(function (root, fabrique) {
  ...
  const JEU_DEMO = [
    { id:'AF1080', cie:'AF', avion:'A320', sens:'DEP', std:6*60+40, bc:12, pc:0,  yc:150, crew:5, spml:6 },
    { id:'TX305',  cie:'TX', avion:'A320', sens:'DEP', std:7*60+5,  bc:16, pc:0,  yc:120, crew:4, spml:4 },
    { id:'AF1180', cie:'AF', avion:'A350', sens:'DEP', std:7*60+30, bc:32, pc:48, yc:210, crew:8, spml:12 },
    { id:'DL84',   cie:'DL', avion:'B777', sens:'DEP', std:8*60+0,  bc:38, pc:40, yc:230, crew:8, spml:14 },
    { id:'FWI40',  cie:'FWI', avion:'A350', sens:'DEP', std:8*60+20, bc:30, pc:44, yc:200, crew:7, spml:10 },
    { id:'CRL76',  cie:'CRL', avion:'A380', sens:'DEP', std:8*60+50, bc:14, pc:76, yc:340, crew:12, spml:18 },
    { id:'AF1290', cie:'AF', avion:'A320', sens:'DEP', std:9*60+10, bc:12, pc:0,  yc:140, crew:5, spml:5 },
    ...
    { id:'AF1680', cie:'AF', avion:'A350', sens:'DEP', std:17*60+20,bc:32, pc:48, yc:205, crew:7, spml:11 },
    { id:'TX315',  cie:'TX', avion:'A320', sens:'DEP', std:17*60+50,bc:16, pc:0,  yc:130, crew:5, spml:5 },
    { id:'QR42',   cie:'QR', avion:'A350', sens:'DEP', std:18*60+30,bc:30, pc:44, yc:210, crew:8, spml:10 },
    { id:'FBU78',  cie:'FBU', avion:'A380', sens:'DEP', std:19*60+0, bc:14, pc:76, yc:350, crew:12, spml:20 },
    { id:'DL88',   cie:'DL', avion:'B777', sens:'DEP', std:19*60+40,bc:38, pc:40, yc:235, crew:8, spml:15 },
